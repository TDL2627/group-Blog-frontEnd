        ...
        <form>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" class="btn btn-primary btn-lg"
              style="padding-left: 2.5rem; padding-right: 2.5rem;"><router-link to="/blogs">Login</router-link></button>
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a
                class="link-danger" style="color:blue"><router-link to="/signup">Register</router-link></a></p>
          </div>
