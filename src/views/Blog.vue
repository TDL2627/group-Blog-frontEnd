...
<div class="Card">
		...
		<div class="Card-body">
				...
				<p class="Card-description">
					...
					magnam ipsum nisi maxime porro voluptates
					numquam, modi ea fugit sapiente architecto
					unde laboriosam illum autem quos? Officia,
					ad vitae?
				</p>
		</div>
	</div>
...
<div class="mb-3">
  <label for="formGroupExampleInput3" class="form-label">Image URL</label>
...
.Card {
	...
	.Card-image {
		flex-basis: 40%;
		background-image: 
			url(http://img.youtube.com/vi/VaCiFX3tkSc/maxresdefault.jpg);
